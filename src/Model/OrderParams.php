...
class OrderParams
{
    ...
    CONST COURIER_SBERLOGISTICS = 'sberlogistics';
    ...
    /**
     * @param string $originSender
     * @return OrderParams
     */
    public function setOriginSender(string $originSender)
    {
     ...
     * @return string
     */
    public function getOriginSender()
    {
    ...
    /**
     * @param bool $returnUtilization
     * @return OrderParams
     */
    public function setReturnUtilization(bool $returnUtilization)
    {
        $this->returnUtilization = $returnUtilization;
     ...
     * @return bool
     */
    public function isReturnUtilization()
    {
        return $this->returnUtilization;
    }
}
